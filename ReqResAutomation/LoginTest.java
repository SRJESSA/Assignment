...
public class LoginTest {
	public static void main(String[] args) {
		...
		LoginTest.user_login_successful();
		LoginTest.user_login_not_successful();
	}

	private static void user_login_successful() {
		...
		Response response = given().spec(req_spec).body(login)
	...
	private static void user_login_not_successful() {
